...
o88o  8  o88o 88oooooo88 o888o o888o      o88oooo888   888o 88ooo88 8o o888ooo88  o888o  88oooo888
 "
# Main Shell Loop
while true; do
    read -rp "$PS3" command args arg2 arg3
     ...
     case "$command" in
        ...
        # --- Msh tools ---
        msh-refresh)
          echo "Msh Stable GitHub Version:"
          wget -qO- https://raw.githubusercontent.com/MEHRAD111/Msh/refs/heads/Rolling-Release/MSH-Sable-4.sh | grep Version   
